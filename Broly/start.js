...
const directories = ['./BrolySession/', './BrolyJadiBot/']
...
setInterval(async () => {
  ...
  const bio = `💚 Broly-Bot-MD |「🕒」Aᥴ𝗍і᥎ᥲ: ${uptime}`;
