...
printQRInTerminal: opcion == '1' ? true : methodCodeQR ? true : false,
mobile: MethodMobile, 
browser: opcion == '1' ? ['BrolyBot-MD', 'Edge', '20.0.04'] : methodCodeQR ? ['BrolyBot-MD', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
keys: makeCacheableSignalKeyStore(state.keys, pino({ level: "fatal" }).child({ level: "fatal" })),
},
...
/*conn.sendMessage("120363350554513092@newsletter", { text: '👋 Hola seguidores!\n💥 Me he conectado nuevamente!!', contextInfo: { externalAdReply: { title: "BROLY-BOT-MD", body: '💥 Broly Bot conectada nuevamente!', thumbnailUrl: ppBot, sourceUrl: 'https://cafirexos.com', mediaType: 1, showAdAttribution: false, renderLargerThumbnail: false }}}, { quoted: null })*/
}
 ...
 */
global.rutaJadiBot = join(__dirname, '../BrolyJadiBot')

if (global.brolyJadibts) {
...
brolyJadiBot({pathBrolyJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
