...
global.lid = [
  ['186397822587042', '𝑹𝒂𝒚𝒐 - 𝑪𝒓𝒆𝒂𝒅𝒐𝒓 ☄️', true],
  ['595992667005']
];

//• ↳𝑺𝑶𝑳𝑶 𝑴𝑶𝑫𝑬𝑹𝑨𝑫𝑶𝑹𝑬𝑺!
global.mods = ['595992809980', '595992667005', '', '', '']
...
global.nameqr = 'Broly Bot - MD'
global.sessions = 'BrolySession'
global.jadi = 'BrolyJadiBot'
global.brolyJadibts = true

//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packsticker = `♾ ━━━━━━━━\n├ ɓσƭ:\n├ ρяοριєταяιο:\n├ ƒєϲнα ∂є ϲяєαϲιόи:\n├ нοяα:\n♾━━━━━━━━`
global.packname = `🌪️⭑𝐁𝐫𝐨𝐥𝐲-𝐁𝐨𝐭⭑(^_^♪)`
global.author = `♾━━━━━━━━\n⇝͟͞ ۵̤͟𝖡𝖱𝖮𝖫𝖸̈͟♡̵̑ ͟͞   ᷨᜳ ͦ ̵ͭ⋆\n⇝ ۵-̱̅𝘙𝘈𝘠𝘖 𝘖𝘍𝘊-͞ˍ\n⇝ ${moment.tz('America/Los_Angeles').format('DD/MM/YY')}\n⇝ ${moment.tz('America/Los_Angeles').format('HH:mm:ss')} \n♾━━━━━━━━\n\n\n\nѕτιϲκєя ϐγ: ৎ୭࠭͢𝗕𝗿𝗼𝗹𝘆🌱̤ʙⷪᴏ͓ᷫᴛⷭ͟ `;
global.wm = 'ৎ୭࠭͢𝗕𝗿𝗼𝗹𝘆-ʙⷪᴏ͓ᷫᴛ 🌱ⷭ͟ ';
global.titulowm = '͟͞ ৎ୭࠭͢𝗕𝗥𝗢𝗟𝗬-𝗕𝗢𝗧-𝗠𝗗 ͟͞';
global.titulowm2 = `͟͞ ৎ୭࠭͢𝐵𝑅𝑂𝐿𝑌-𝐵𝑂𝑇-𝑀𝐷 ͟͞`
global.igfg = 'ᥫᩣ𝘙𝘈𝘠𝘖 𝘖𝘍𝘊࠭⋆̟'
global.botname = '⏤͟͞ू⃪ ፝͜⁞ᗷᖇOᒪY⃔࿐'
global.dev = '© 𝗉᥆ᥕᥱrᥱძ ᑲᥡ 𝖱𝖺𝗒𝗈 ⚡'
global.textbot = '⏤͟͞ू⃪ ፝͜⁞𝖡𝗋𝗈𝗅𝗒-𝖡𝗈𝗍-𝖬𝖣⃜✰⃔࿐ : ᥫᩣ𝖱𝖠𝖸𝖮 𝖮𝖥𝖢࠭⋆̟'
global.gt = '͟͞ ৎ୭࠭͢ᖇᗩYO Oᖴᑕ ͟͞';
global.namechannel = '⏤͟͞ू⃪ ፝͜⁞𝙱𝚁𝙾𝙻𝚈-𝙱𝙾𝚃-𝙼𝙳⃜✰⃔࿐/ᥫᩣ𝚁𝙰𝚈𝙾 𝙾𝙵𝙲 ⚡࠭⋆̟'
...
watchFile(file, () => {
  unwatchFile(file);
  console.log(chalk.redBright('Update \'Broly/config.js\''));
